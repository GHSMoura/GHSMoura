...
- **Impacto:** Detecção precisa de fraudes em transações financeiras  
- **Resultados:** Validação cruzada e métricas de recall/precisão robustas  

### [E-Commerce – Comportamento de Clientes](https://github.com/GHSMoura/E-Commerce-)
- **Técnicas:** RFM, análise estatística, Pandas, Seaborn, Matplotlib  
- **Impacto:** Identificação de padrões de compra e segmentação de clientes  
- **Resultados:** Insights aplicáveis para campanhas de marketing e aumento de receita  

### [Novo Sistema Online – Teste A/B](https://github.com/GHSMoura/Novo_Sistema_Online)
- **Técnicas:** Teste Z, análise de funil, Pandas, NumPy, Matplotlib  
- **Impacto:** Avaliação de estratégias de marketing sobre conversão e receita  
- **Resultados:** Métricas claras para tomada de decisão baseada em dados  

### [Porto Dashboard](https://github.com/GHSMoura/Porto-Dashboard)
- **Técnicas:** HTML, CSS, JavaScript, Leaflet.js  
- **Impacto:** Visualização interativa de dados urbanos e demográficos  
- **Resultados:** Dashboard acessível, intuitivo e de fácil interpretação  

 **[Clique aqui para ver todos os outros projetos](https://github.com/GHSMoura?tab=repositories)**
